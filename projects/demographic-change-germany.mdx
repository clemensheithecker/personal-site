...
Find my detailed implementation of the visualizations in [notebook.Rmd](https://github.com/clemensheithecker/demographic-change-germany/blob/main/notebook.Rmd) or [notebook.html](/projects/demographic-change-germany/notebook.html).
