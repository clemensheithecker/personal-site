...
Find a detailed implementation of the exploratory data analysis and visualizations in [data_exploration.ipynb](https://github.com/clemensheithecker/clickbait-headline-classification/blob/main/data_exploration.ipynb) or [data_exploration.html](https://github.com/clemensheithecker/clickbait-headline-classification/blob/main/data_exploration.html).
...
Find a detailed implementation of the machine learning models in [headline_classification.ipynb](https://github.com/clemensheithecker/clickbait-headline-classification/blob/main/headline_classification.ipynb) or [headline_classification.html](https://github.com/clemensheithecker/clickbait-headline-classification/blob/main/headline_classification.html).
